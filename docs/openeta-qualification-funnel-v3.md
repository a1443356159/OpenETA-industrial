...
- Before IK, placement qualification executes two complete deterministic
  ...
  evaluates every surviving grasp/goal pair: compiled hover/release/retreat
  consistency, per-stage analytic reach, attached-object collision, and exact
  URDF primitive collision for the gripper mount. These analytic proofs are
