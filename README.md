...
| [Gazebo M6 placement](docs/gazebo-m6-constraint-correct-placement.md) | Real AnyGrasp/AnyPlace compilation, MoveIt scene constraints, recovery, and live acceptance gates |
